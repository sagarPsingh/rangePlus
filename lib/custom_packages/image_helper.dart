...
import 'package:range_plus_flutter_app/const.dart';

enum ImageType { asset, file, network, memory }
...
class ImageHelper extends StatelessWidget {
  ...
  Widget get _cached => (this.image != null &&
          (this.image.contains('.png') ||
              this.image.contains('.jpg') ||
              this.image.contains('.PNG') ||
              this.image.contains('.JPG') ||
              this.image.contains('.jpeg') ||
              this.image.contains('.JPEG')))
      ? FadeInImage.assetNetwork(
          placeholder: kImagePlaceHolderPath,
          imageErrorBuilder: (ctx, obj, trace) => Image.asset(
  ...
  Widget get _errorBuilder =>
      errorBuilder == null ? Container() : errorBuilder!;
